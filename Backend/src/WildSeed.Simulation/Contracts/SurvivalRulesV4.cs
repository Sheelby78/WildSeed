...
public static class SurvivalRulesV4
{
    ...
    public const int HungerMetabolismCadenceTicks = 3;
    ...
    public const int PredationHungerGain = 800;
    public const int PredationEnergyGain = 500;
    public const int FoodNeedPerVegetationUnit = 8;
    public const int VegetationEnergyGainPerUnit = 1;
    ...
    public const int DangerPerceptionRadius = 6;
    public const int HuntPerceptionRadius = 16;
    public const float AttackRangeSquared = 1.0f;
    public const float SprintSpeedMultiplier = 1.5f;
    public const float HuntSpeedMultiplier = 1.75f;
    public const float FleeSpeedMultiplier = 1.35f;
    public const int CriticalNeed = 750;
    public const int ActionNeedThreshold = 150;
    public const int HerbivoreMaximumAgeTicks = 3_000;
    public const int CarnivoreMaximumAgeTicks = 5_000;
    public const int MaximumAgeTicks = 3_500;
    ...
    public const int MatingCooldownTicks = 1000;
