...
public sealed record SimulationSnapshotResponse(
    long Tick,
    bool IsRunning,
    string Speed,
    string Fingerprint,
    ...
    IReadOnlyList<RuntimeOrganismDto> Organisms,
    EcosystemStatisticsSummaryDto? Statistics = null,
    IReadOnlyList<SimulationHistoryPointDto>? History = null)
{
